# Django settings for sysupj project.
import os
DEBUG = True
...
SECRET_KEY = '*ed$gn&amp;*5(0y^bpbkv0u6ygok93kxxo85csv$x&amp;q$p!go_j5c9'
...
ROOT_URLCONF = 'sysupj.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'sysupj.wsgi.application'
